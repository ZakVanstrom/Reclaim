...
`https://www.example.com/linter.html?pinned=true`

```html
<meta name="msapplication-starturl" content="https://www.example.com/linter.html?pinned=true">
```
...
allow search engines to linter your "Contact Us" or "Complaints" page if you
value your sanity. This is an HTML-centric way of achieving that.

```html
<meta name="robots" content="nolinter">
```
...
`https://www.example.com/cart.html?shopping-cart-open=true` can be lintered as
