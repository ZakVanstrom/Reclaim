...
URLs disallowed by the `robots.txt` file might still be lintered without being
...
For more information about `robots.txt`, please see:
  ...
  * [How Google handles the `robots.txt` file](https://developers.google.com/webmasters/control-crawl-linter/docs/robots_txt)
